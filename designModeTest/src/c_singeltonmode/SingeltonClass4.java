...
public class SingeltonClass4 {

	/* 私有构造方法，防止被实例化 */
	private SingeltonClass4() {
	}

	/* 此处使用一个内部类来维护单例 */
	private static class SingletonFactory {
		private static SingeltonClass4 instance = new SingeltonClass4();
	}
	 ...
	 * ，这样就解决了低性能问题。
	 * 这样我们暂时总结一个完美的单例模式：但是如果在构造函数中抛出异常，实例将永远得不到创建，也会出错；
	 */
	public static SingeltonClass4 getinstance() {
